...
.comment-body {
  ...
  <body>
    ...
    <div id="page-trifurcation">
      <img  style="max-width: 25%;" class="page-item monty" data-set="1" src="/iit/resources/images/mont1.jpg" alt="pic of my cat">
   ...
   ?>
      ...
      <img style="max-width: 25%; transform: scaleX(-1);" class="page-item monty" data-set="1" src="/iit/resources/images/mont1.jpg" alt="pic of my cat">
      </div>
    </div>
  </body>
  </html>
